                    ...
                    <div class="card-body">
                        <form action="{{ route('pendidikan.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('thn_masuk') is-invalid @enderror" name="thn_masuk" value="{{ old('thn_masuk') }}" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('thn_lulus') is-invalid @enderror" name="thn_lulus" value="{{ old('thn_lulus') }}" >
